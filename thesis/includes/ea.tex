...
Komplexer wird die Binärkodierung erst, wenn reelle Zahlen statt ganzen Zahlen repräsentiert werden müssen, oder für das Problem mehrere Parameter optimiert werden müssen. 

Werden die Schalter aus dem Beispiel oben durch stufenlose Dimmer ausgetauscht, muss die Kodierung für das Problem angepasst werden. Die Dimmer akzeptieren jeden reellen Zahlenwert zwischen 0 und 1 als Zustand. Jedoch lässt sich eine reelle Zahl nur mit einer begrenzten Genauigkeit darstellen. 
